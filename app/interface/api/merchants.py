...
from app.interface.api.dependencies import get_current_user, get_merchant_service
from app.interface.schemas.merchant import MerchantCreateRequest, MerchantResponse
